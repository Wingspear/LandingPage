...
const BANNER_DATA = {
  HEADING: "Go digital with Vision",
  DECRIPTION:
    "Vision can help you skyrocket the ROI of your marketing campaign without having to spend tons of money or time to assemble an in-house team.",
  TUTORIAL_URL:
...
const FOOTER_DATA = {
  ...
  CONTACT_DETAILS: {
    HEADING: "Contact us",
    ADDRESS: "USC Village, Los Angeles",
